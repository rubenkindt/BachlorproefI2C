...
byte const sensorNr[]= {17,33};//{B00010001,B00100001}; //de adressen van de slaves, LSB moet 1 zijn, want we gaan enkel lezen van de slaves
...
#define SNELHEID 125  //1khz voor 8 bit ->  125ms voor 1 bit
                      //10% flank 
...
boolean lissenForAck(){
  ...
  pinMode(SDA,INPUT);
  delay(SNELHEID*3);  //slave adres laten controlleren
  float factor=2.0;
  int i=0;
  int debounce=5;
